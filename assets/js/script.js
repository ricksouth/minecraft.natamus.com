		...
		success: function(data){
			...
			for (var i = 0; i < dataspl.length; i++) {
				...
				if (line.includes("/mc-mods/")) {
					...
					html += '<div class="col mod"><a href="' + url + '"></a><a href="' + url + '"></a><a href="' + url + '"></a><a href="' + url + '"></a><div id="mod' + i + '" class="box"></div><img class="dlshield" href="https://cf.way2muchnoise.eu/' + slug + '.svg" alt="' + name + '"></div>';
